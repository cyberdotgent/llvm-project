...
; CHECK:         ADDN        [[BP:T[0-9]+]],536870916,2;
; CHECK-NEXT:         CPYNV       OFF,[[BP]];
; CHECK:              ADDSPP      .LS,.S_BASE,OFF;
; CHECK:              CPYBLA      LS_I1,X'2A';
; CHECK:         CPYBLA      U1_BOX,X'00000000';
; CHECK-NEXT:         CPYBLA      U1_BYTE,LS_I1;
; CHECK-NEXT:         CPYNV       {{T[0-9]+}},U1_NUM;
; CHECK:         ADDN        [[SP:T[0-9]+]],536870920,4;
; CHECK-NEXT:         CPYNV       OFF,[[SP]];
; CHECK:              ADDSPP      .LS,.S_BASE,OFF;
; CHECK:              CPYNV       LS_I2,1234;
; CHECK:         CPYNV       {{T[0-9]+}},LS_I2;
